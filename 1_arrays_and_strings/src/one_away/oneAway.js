...
console.log(`${a}\t|\t${a}\t|\t${oneOrLessAway(a, a)}`);
console.log(`${a}\t|\t${b}\t|\t${oneOrLessAway(a, b)}`);
console.log(`${a}\t|\t${c}\t|\t${oneOrLessAway(a, c)}`);
console.log(`${a}\t|\t${d}\t|\t${oneOrLessAway(a, d)}`);
console.log(`${a}\t|\t${e}\t|\t${oneOrLessAway(a, e)}`);
console.log(`${a}\t|\t${f}\t|\t${oneOrLessAway(a, f)}`);

 ...
 */
 ...
 public class PalindromePermutation {
    ...
    public static void main(String[] args) {
      ...
      System.out.println(b + ": " + isPalindromePermutation(b));
      System.out.println(c + ": " + isPalindromePermutation(c));
      System.out.println(d + ": " + isPalindromePermutation(d));

      System.out.println("\n*** Version 2");
      System.out.println(a + ": " + isPalindromePermutation2(a));
      System.out.println(b + ": " + isPalindromePermutation2(b));
      System.out.println(c + ": " + isPalindromePermutation2(c));
      System.out.println(d + ": " + isPalindromePermutation2(d));
   }
